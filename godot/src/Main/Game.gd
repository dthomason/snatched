...
export (PackedScene) var Player = preload("res://src/Characters/Player.tscn")
export (PackedScene) var map_scene = preload("res://src/World/backup_lobby_inherit.tscn")

onready var map: Node2D = $World
onready var players_node := $Player
