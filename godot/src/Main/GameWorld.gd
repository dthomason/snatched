...
func _ready() -> void:
#	PlayerScene = load("res//src/Characters/Player.tscn")
	RunnerScene = load("res//src/Characters/runner/runner.tscn")
	SeekerScene = load("res//src/Characters/seeker/seeker.tscn")
#	LobbyScene = load("res//src/Main/Lobby.tscn")
...
func join_world(
	...
	character = SeekerScene.instance() if presences == null else RunnerScene.instance()
...
func create_character(id: String,
	username: String,
	position: Vector2,
	direction_x: float,
	color: Color,
